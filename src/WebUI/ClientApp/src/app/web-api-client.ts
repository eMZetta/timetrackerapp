...
export interface IBookingTypeClient {
...
export class BookingTypeClient implements IBookingTypeClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getAll(): Observable<BookingType[]> {
        let url_ = this.baseUrl + "/api/BookingType";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<BookingType[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<BookingType[]>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<BookingType[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(BookingType.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
...
export interface ITimeTrackingClient {
    ...
    create(item: TimeTracking): Observable<TimeTracking>;
    getById(id: number): Observable<TimeTracking>;
    update(id: number, item: TimeTracking): Observable<FileResponse>;
    delete(id: number): Observable<FileResponse>;
}
...
export class TimeTrackingClient implements ITimeTrackingClient {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<TimeTracking[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<TimeTracking[]>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<TimeTracking[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(TimeTracking.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
    ...
    protected processCreate(response: HttpResponseBase): Observable<TimeTracking> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = TimeTracking.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    protected processGetById(response: HttpResponseBase): Observable<TimeTracking> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
